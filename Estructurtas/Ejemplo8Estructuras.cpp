...
int main(){ 
    ...
    Cliente cliente6;
    cout << "Cliente: ";
    cin.getline(cliente6.nombre,20); cin.sync();
    cout << "Unidad: ";
    ...
    cin >> cliente6.estado;
    cout << "Los valores del cliente6 son: "<< cliente6.nombre<<", "<<cliente6.nomUnidades<<", "<<cliente6.precio<<", "<<cliente6.estado <<endl; 
    
    Cliente *cliente7= new Cliente;
    cout << "\nCliente: ";
    cin.getline(cliente7->nombre,20);cin.sync();
    cout << "\nUnidad: ";
    cin >> cliente7->nomUnidades;
    cout << "Precio: ";
    cin >> cliente7->precio;
    cout << "Estado(M=Moroso,A=Atrasado, P=Pagado): ";
    cin >> cliente7->estado;
    cout << "\nLos valores del cliente6 son: "<< cliente7->nombre<<", "<<cliente7->nomUnidades<<", "<<cliente7->precio<<", "<<cliente7->estado <<endl; 
    delete cliente7;
